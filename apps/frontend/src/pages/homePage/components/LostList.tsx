    ...
    <div className="container mx-auto px-4">
      <section className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-foreground">失物寻回</h2>
          <Link to="/lost" className="text-primary hover:underline flex items-center">
            ...
            <div
              ...
              <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs ${item.status === LOST_FILTER_STATUS.寻找中 ? 'bg-destructive/10 text-destructive' : 'bg-success/10 text-success'}`}>
