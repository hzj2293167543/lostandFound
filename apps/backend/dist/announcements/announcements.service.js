...
const announcements_mapper_1 = require("./announcements.mapper");
let AnnouncementsService = class AnnouncementsService {
    ...
    async findTop(limit) {
        ...
        return announcements.map((announcement) => (0, announcements_mapper_1.mapAnnouncementToVo)(announcement));
    }
    create(data) {
