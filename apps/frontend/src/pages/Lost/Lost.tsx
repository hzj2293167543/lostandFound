...
const mockLostItems = [
  {
    ...
    title: '蓝色笔记本电脑',
    category: '电子产品',
    description: '联想小新Pro，蓝色外壳，有轻微划痕，于2024年2月20日在图书馆三楼丢失',
    time: '2024-02-20',
    location: '图书馆三楼',
    status: '寻找中',
    image:
  ...
  },
  {
    ...
    title: '黑色钱包',
    category: '证件卡包',
    description: '黑色皮质钱包，内有身份证、学生证和银行卡，于2024年2月19日在食堂二楼丢失',
    time: '2024-02-19',
    location: '食堂二楼',
    status: '寻找中',
    image:
  ...
  },
  {
    ...
    title: '红色雨伞',
    category: '生活用品',
    description: '折叠式红色雨伞，伞柄有小熊图案，于2024年2月18日在教学楼A座丢失',
    time: '2024-02-18',
    location: '教学楼A座',
    status: '已找到',
    image:
  ...
  },
  {
    ...
    title: '白色运动鞋',
    category: '服饰',
    description: '耐克白色运动鞋，尺码42，于2024年2月17日在体育馆丢失',
    time: '2024-02-17',
    location: '体育馆',
    status: '寻找中',
    image:
      'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=white%20sports%20shoes%20nike&image_size=square',
    user: {
      id: 4,
      name: '赵六',
      avatar:
  ...
  },
  {
    ...
    title: '数学课本',
    category: '学习用品',
    description: '高等数学上册，封面有笔记，于2024年2月16日在教室302丢失',
    time: '2024-02-16',
    location: '教室302',
    status: '已找到',
    image:
