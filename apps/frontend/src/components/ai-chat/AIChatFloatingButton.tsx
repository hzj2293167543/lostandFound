  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 size-14 rounded-full bg-gradient-to-br from-ai-primary to-ai-secondary shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group"
        aria-label="打开AI助手">
